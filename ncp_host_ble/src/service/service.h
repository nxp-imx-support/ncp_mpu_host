...
#define GATT_PRIMARY_SERVICE(_uuid)                  HOST_GATT_ATTRIBUTE(NCP_BRIDGE_CMD_GATT_ADD_SERVICE_TLV, _uuid, NULL, NULL)
#define GATT_CHARACTERISTIC(_uuid, _props, _perm)    HOST_GATT_ATTRIBUTE(NCP_BRIDGE_CMD_GATT_ADD_CHRC_TLV, _uuid, _props, _perm)
#define GATT_CCC(_perm)                              HOST_GATT_ATTRIBUTE(NCP_BRIDGE_CMD_GATT_ADD_DESC_TLV, UUID_GATT_CCC, NULL, _perm)
