...
void peripheral_hrs_task(void)
{
    ...
    do
    {
        if(hrs_profile[arg].type == NCP_BRIDGE_CMD_GATT_ADD_SERVICE_TLV)
        {
        ...
        else if(hrs_profile[arg].type == NCP_BRIDGE_CMD_GATT_ADD_CHRC_TLV)
        {
        ...
        else if(hrs_profile[arg].type == NCP_BRIDGE_CMD_GATT_ADD_DESC_TLV)
        {
